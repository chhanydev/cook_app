...
public class AllFoodFragment extends Fragment {
    ...
    private final String URL = "http://10.0.2.2:8080/android/index.php";
    List<Food> foodList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_all_food, container, false);
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.allfoods);
