...
public class FoodCFragment extends Fragment {


    private View view;
    private RecyclerView recyclerView;
    private final String URL = "http://10.0.2.2:8080/android/foodc.php";
    List<Food> foodList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=  inflater.inflate(R.layout.fragment_food_c, container, false);
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.foodc);
