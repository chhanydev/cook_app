...
public class FoodBFragment extends Fragment {


    private View view;
    private RecyclerView recyclerView;
    private final String URL = "http://10.0.2.2:8080/android/foodb.php";
    List<Food> foodList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         view = inflater.inflate(R.layout.fragment_food_b, container, false);
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.foodb);
